...
import au.com.mongodb.services.v1.health.HealthService;
...
public class AppMain {
    ...
    private final String CONTEXT_PATH_SEPARATOR = "/rest";
    ...
    private Server configureServer() {
        ...
        resourceConfig.packages(HealthService.class.getPackage().getName());
